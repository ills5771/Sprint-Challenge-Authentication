...
To persist username and password of the user so they don't have to
keep entering the information over and over with each request.

1. What does bcrypt do to help us store passwords in a secure manner.
   it hashes passwords and implements salting

1) What does bcrypt do to slow down attackers?

the hash function can be tuned to run slower in newer machines, scaling with
computing power.
